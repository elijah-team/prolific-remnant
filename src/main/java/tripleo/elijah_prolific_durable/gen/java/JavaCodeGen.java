package tripleo.elijah_prolific_durable.gen.java;
...
//				tripleo.elijah.util.Stupidity.println2(ctc.toString());
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
//		else {
...
//				}
//				tripleo.elijah.util.Stupidity.println2(String.format("%s vv%s;", theType, ii.name));
//
//			}
//		else if (element instanceof ProcedureCallExpression) {
//			ProcedureCallExpression pce = (ProcedureCallExpression) element;
//			tripleo.elijah.util.Stupidity.println2(String.format("%s(%s);", pce./*target*/getLeft(), pce.exprList()));
...
//
//					tripleo.elijah.util.Stupidity.println2(String.format("{for (int %s=%d;%s<=%d;%s++){\n\t",
...
//
//					tripleo.elijah.util.Stupidity.println2(String.format("{for (int %s=%d;%s<=%s;%s++){\n\t",
//							varname, fromPart.getValue(),
//							varname, "vv"+toPart.getText(),  varname));
//
//				}
//				for (StatementItem item : loop.getItems()) {
//					tripleo.elijah.util.Stupidity.println2("\t"+item);
//				}
//				tripleo.elijah.util.Stupidity.println2("}");
//			} else throw new NotImplementedException();
//		} else {
//			tripleo.elijah.util.Stupidity.println2(element);
//
//		}
//	}
//
