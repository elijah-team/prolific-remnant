...
//	private final IO io;
//	private final tripleo.elijah.comp.USE use = new tripleo.elijah.comp.USE(this);
	//
	//
	//
	...
	public void feedCmdLine(final @NotNull List<String> args) {
		feedCmdLine(args, new tripleo.elijah.comp.DefaultCompilerController());
	}
	...
	public void feedCmdLine(final List<String> args, final CompilerController ctl) {
		...
		if (ctl instanceof tripleo.elijah.comp.DefaultCompilerController) {
...
//		private final Compilation            c;
		...
		public MOD(final tripleo.elijah.comp.Compilation aCompilation) {
//			c = aCompilation;
		}
	...
	static class CIS implements io.reactivex.rxjava3.core.Observer<CompilerInstructions> {
